...
#### 완료 조건 체크리스트
- [x] Vite 또는 CRA로 React 프로젝트 생성 완료
...
#### 완료 조건 체크리스트
- [x] API 클라이언트 설정 완료 (axios 또는 fetch)
- [x] 인증 서비스 구현 완료 (register, login)
- [x] Todo API 서비스 구현 완료 (CRUD)
- [x] 요청/응답 인터셉터 구현
- [x] 토큰 관리 (localStorage) 완료
- [x] 에러 처리 구현 완료
...
### MVP 완료 기준
- [x] 모든 데이터베이스 Task 완료 (DB-1 ~ DB-4)
- [x] 모든 백엔드 Task 완료 (BE-1 ~ BE-10)
- [x] 모든 프론트엔드 Task 완료 (FE-1 ~ FE-7)
